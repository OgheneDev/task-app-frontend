...
export const LoginForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setIsLoading(false);
      // Optionally keep password: setPassword('');
    }
  };
        ...
        <div className="rounded-md shadow-sm p-4 space-y-3">
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`absolute right-3 top-[70%] -translate-y-1/2 ${isDark ? 'text-gray-400' : 'text-gray-500'} hover:text-gray-700 dark:hover:text-gray-300`}
            >
              {showPassword ? (
